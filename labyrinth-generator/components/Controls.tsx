      ...
      <div className="flex flex-wrap items-center justify-between gap-y-3 gap-x-2 md:gap-x-6 text-sm text-slate-300">
        ...
        <div className="flex items-center gap-3 md:gap-6 ml-auto">
          <div className="flex flex-col gap-1 w-20 md:w-auto">
            <label className="text-[9px] md:text-[10px] uppercase font-bold text-slate-500">Delay: {speed}ms</label>
            <input
              type="range"
              min="1"
              max="50"
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                // Approximate rows based on 16:9 aspect ratio or similar
                // to keep a balanced grid, but App.tsx will clamp it to fit screen anyway
